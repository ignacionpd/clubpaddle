    ...
    <div class="mi_contenedor">
        ...
        <main class="mi_principal">
            ...
            <section class="section_border_top">
                ...
                <div class="admin_users_container" id="admin_users_container">
                                    ...
                                    <div class="admin_user_view">
                                        ...
                                        <div class="admin_user_actions">
                                            ...
                                            <form method="post" action="../../controllers/admin/c_usuarios_admin.php">
                                                ...
                                                <button type="submit" class="btn_delete" name="borrar_usuario">Borrar</button>
                                            </form>
                                        </div>
                                    </div>

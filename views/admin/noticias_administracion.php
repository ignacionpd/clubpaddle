            ...
            <div class="admin_noticia_create">
                ...
                <form id="form_crear_noticia"
                    ...
                    <div class="form_row">
                        ...
                        <input type="text" id="titulo" name="titulo" title="El título debe tener mínimo 5 caracteres" required>
                    ...
                    <div class="form_row">
                        ...
                        <textarea id="texto" name="texto" title="El texto debe contener 10 caracteres como mínimo" required></textarea>
                        <small class="input_error"></small>
                    </div>
                    ...
                    <div class="form_row">
                        ...
                        <input type="file" id="imagen" name="imagen" accept="image/*" title="La imagen es obligatoria" required>
                        <small class="input_error"></small>
                    ...
                    <?php foreach ($noticias as $n): ?>
                        ...
                        <div class="admin_noticia_card">
                            ...
                            <div class="admin_noticia_view">
                                <h3 class="noticia_titulo"><?= htmlspecialchars($n['titulo']) ?></h3>

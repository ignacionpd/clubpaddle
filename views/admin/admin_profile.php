...
<body>
    <div class="mi_contenedor">
        ...
        <header class="mi_encabezado">
            ...
            <nav class="navigationBar">
                <ul class="navigationBarList">
                    ...
                    <li>
                        <a class="enlace active" href="#">Perfil</a>
                    </li>
                    <li>
        ...
        <main class="mi_principal">
            <section>
                ...
                <form class="user_profile" id="user_profile_form" action="../../controllers/admin/c_admin_profile.php" method="post">
                    ...
                    <div class="form_buttons">
                        <button class="btn_modificar_usuario" type="submit" class="btn_enviar" name="actualizar_perfil">Actualizar datos</button>
                    </div>
                </form>

                <hr>

                <form class="user_profile" id="user_password_form" action="../../controllers/admin/c_admin_password.php" method="post">
                    ...
                    <div class="form_buttons">
                        <button class="btn_modificar_usuario" type="submit" class="btn_enviar" name="cambiar_contrasena">Cambiar contraseña</button>
                    </div>
                </form>
    ...
    <script src="../../assets/scripts/v_update_user.js"></script>
</body>

        ...
        <header class="mi_encabezado">
            ...
            <nav class="navigationBar">
                ...
                <ul class="navigationBarList">
                    ...
                    <li><a class="enlace" href="./views/noticias.php">Noticias</a></li>

                    <?php if (!isset($_SESSION["user_data"])): ?>
                        <li><a class="enlace" href="./views/registro.php">Registro</a></li>
                        <li><a class="enlace" href="./views/login.php">Login</a></li>
                    <?php endif; ?>
                </ul>
                ...
                <?php if (isset($_SESSION["user_data"])): ?>
                    <ul class="navigationBarListUser">
                        ...
                        <?php if ($_SESSION["user_data"]['rol'] === "admin"): ?>
                            ...
                            <li><a class="enlace" href="./views/admin/usuarios_administracion.php">Administración Usuarios</a></li>
                            <li><a class="enlace" href="./views/admin/citas_administracion.php">Administración Citas</a></li>
                            <li><a class="enlace" href="./views/admin/noticias_administracion.php">Administración Noticias</a></li>
                            <li><a class="enlace" href="./views/admin/admin_profile.php">Perfil</a></li>
                            <li><a class="enlace" href="./controllers/users/logout.php">Cerrar sesión</a></li>

                        <?php elseif ($_SESSION["user_data"]['rol'] === "user"): ?>

                            <li><a class="enlace" href="./views/users/citas.php">Citas</a></li>
                            <li><a class="enlace" href="./views/users/user_profile.php">Perfil</a></li>
